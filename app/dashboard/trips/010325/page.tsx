export default function Page() {
  return (
    <div>
      <header className='text-4xl font-bold text-left'>Avalanche Course Day 2</header>
      <p className='text-gray-500'>Published November 21, 2025</p>
      <div className='grid grid-cols-2'>
        <ul className='p-6'>
          <li className='p-3'>Date: Jan 3, 2025</li>
          <li className='p-3'>Location: Vail Pass</li>
          <li className='p-3'>Weather: Sunny and chilly</li>
          <li className='p-3'>Crew: Peter, Carter, Mia and myself</li>
