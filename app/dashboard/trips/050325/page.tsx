export default function Page() {
  return (
    <div>
      <header className='text-4xl font-bold text-left'>Loveland Pass</header>
      <p className='text-gray-500'>Published November 16, 2025</p>
      <div className='grid grid-cols-2'>
        <ul className='p-6'>
          <li className='p-3'>Date: May 3, 2025</li>
          <li className='p-3'>Location: Loveland Pass Trailhead</li>
          <li className='p-3'>Weather: Sunny and warmer</li>
        ...
        <div className=''>
          <img className='max-h-96' src='/loveland_pass.jpg'></img>
        </div>
      </div>
