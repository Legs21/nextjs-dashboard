export default function Page() {
  return (
    <div>
      <header className='text-4xl font-bold text-left'>Watrous Gulch</header>
      <p className='text-gray-500'>Published November 21, 2025</p>
      <div className='grid grid-cols-2'>
        <ul className='p-6'>
          <li className='p-3'>Date: Apr 19, 2025</li>
          <li className='p-3'>Location: Watrous Gulch Trailhead</li>
          <li className='p-3'>Weather: Sunny and warmer</li>
          <li className='p-3'>Crew: Carter, Peter, Sten and myself</li>
